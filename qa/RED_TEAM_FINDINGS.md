...
- Scope risk: the business model is operated partner qualification by OCTOPUS Mining, not an open marketplace. Public copy must not imply self-serve payments, public APIs, webhooks or external integrations while V1 flags stay closed.
